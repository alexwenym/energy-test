...
// main function
void mean_comparison(string infile1name, string infile2name, Int_t nbins, Int_t npermutations, Double_t delta) {
// two input files 
...
//Double_t nmean1 = 2*runningsum / (si1 * (si1-1)); 

shist1->Scale(1.0/(si1*(si1-1))); 
shist2->Scale(1.0/(si2*(si2-1)));

cout << si1 << " and " << si2 << endl; 
